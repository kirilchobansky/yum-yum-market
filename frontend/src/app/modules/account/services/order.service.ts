...
import { ORDERS_CREATE_URL, ORDERS_GET_BY_ID_URL, ORDERS_NEW_CURRENT_USER_URL, ORDERS_PAID_URL, ORDERS_PAY_URL } from 'src/app/core/constans/urls';
...
export class OrderService {
  ...
  getPaidOrders(): Observable<Order[]>{
    return this.http.get<Order[]>(ORDERS_PAID_URL);
  };
}
